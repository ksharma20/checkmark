...
export const meSettings = {
  ...
  settings: {
    ...
    notifications: {
      ...
      pushBody:
        'CheckMark registers this browser for push when you open it. Unregistering stops push here immediately, but opening CheckMark again registers it back — mute the categories above to stop the messages themselves.',
