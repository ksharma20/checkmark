...
const S = {
  ...
  h2: { fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: 'clamp(24px, 3.5vw, 36px)', lineHeight: 1.15, letterSpacing: '-0.8px', color: 'var(--navy)', margin: 0 } as React.CSSProperties,
