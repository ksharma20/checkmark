...
//   DB rename - if checkmark.db absent but checkmark.db present, copies it automatically.
...
async function seedRolesAndOwners(all, exec) {
  ...
  for (const ws of workspaces) {
    for (const role of SYSTEM_ROLE_SEED) {
      ...
      // CheckMark's to define - when their permissions change (or a new resource is
